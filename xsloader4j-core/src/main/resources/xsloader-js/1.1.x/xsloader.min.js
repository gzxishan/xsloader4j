/*!
 * xsloader.min.js v1.1.35
 * home:https://github.com/gzxishan/xsloader#readme
 * (c) 2018-2020 gzxishan
 * Released under the Apache-2.0 License.
 * build time:Fri Dec 04 2020 16:24:16 GMT+0800 (GMT+08:00)
 */
(function () {
  'use strict';
  ...
  var G$6=U.global,L$b=G$6.xsloader,defineHandle=script.initDefine(function(a){var b=1<arguments.length&&arguments[1]!==void 0?arguments[1]:function(){};U.each(a,function(a){if(L$b.isFunction(a.callback)){var c=a.callback;a.callback=function(){var b=L$b.config(),d,e;U.each(a.names,function(a){var c=b.defineFunction[a];if(L$b.isFunction(c)){e=c;return false}});if(e){for(var f=[],g=0;g<arguments.length;g++){f.push(arguments[g]);}d=e.apply(this,[c,this,f]);}else {d=c.apply(this,arguments);}c=null;return d};}onModuleLoaded(a,moduleScript.getLastDefineObject(a.src));b();});});function onModuleLoaded(a,b){moduleScript.appendLoadingModuleDeps(a);var c=moduleScript.getModule(a.src,a.selfname);if(!c&&a.srcBeforeCurrentPath){c=moduleScript.getModule(a.srcBeforeCurrentPath);if(c){c.src=a.src;c.scriptSrc=a.scriptSrc;moduleScript.setModule(null,c);}}if(c){if("loading"==c.state){c.reinitByDefineObject(a);}}else {c=moduleScript.newModule(a);}if(a.selfname!=a.src){a.pushName(a.selfname);}if(c.selfname!=a.src){a.pushName(c.selfname);}U.each(a.names,function(a){moduleScript.setModule(a,c);if(L$b.ignoreAspect_[a]){c.ignoreAspect=true;}});a.appendConfigDepsAndEmbedDeps(c);var d=c;if(a.handle.before){a.handle.before(d.deps);}if(b&&b.handle.depBefore){b.handle.depBefore(b.index,d.selfname,d.deps,2);}d.setState("loaded");d.setInstanceType(a.handle.instance||L$b.config().instance);if(0==d.deps.length){try{d.finish([]);}catch(b){a.handle.onError(b);}}else {var e=function(){moduleScript.everyRequired(a,d,function(b){var c=[],e=[];U.each(b,function(a){e.push(a);c.push(a&&a.moduleObject());});c.push(e);try{d.finish(c);}catch(b){a.handle.onError(b);}},function(b,c){return a.handle.onError(b,c)});};if(a.isRequire){e();}else {d.whenNeed(e);}}}var define=function(){return defineHandle.predefine.apply(this,arguments)},require=function(){return defineHandle.prerequire.apply(this,arguments)};require.get=function(a){if(!L$b.isString(a)){throw new Error("expected string type for module name")}else {return require.call(this,a)}};require.has=function(){var a=arguments;if(0==a.length){return false}for(var b=0,c;b<a.length;b++){c=moduleScript.getModule(a[b]);if(!c||"defined"!=c.state){return false}}return true};L$b.define=define;L$b.defineAsync=define;L$b.require=require;G$6.define=define;G$6.require=require;define.amd=true;define("exports",function(){});
  ...
  var L$e=U.global.xsloader;L$e.define("try",{isSingle:true,pluginMain:function pluginMain(a,b){var c=a,d=this.invoker().withAbsUrl().require([c],function(a){b(a);}).error(function(a,d){console.info("try!:require '".concat(c,"' failed"));this.logError(a,d,"info");return {ignoreErrState:true,onGetModule:function onGetModule(){return null},onFinish:function onFinish(){b(null);}}}).setTag("try!".concat(a));if(d.waitTime&&1e3<d.waitTime){d.waitTime-=1e3;}}});

  var L$f=U.global.xsloader;L$f.define("nodeps",{isSingle:true,pluginMain:function pluginMain(a,b,c){this.invoker().withAbsUrl().require([a],function(a){b(a);}).then({depBefore:function depBefore(a,b,c){c.splice(0,c.length);}}).error(function(a){c(a);}).setTag("nodeps!".concat(a));}});
  ...
  var L$j=U.global.xsloader;L$j.define("text",["xshttp"],{isSingle:true,pluginMain:function pluginMain(a,b,c,d,e){var f=this.invoker().getUrl(a,true);e().url(f).handleAs("text").ok(function(a){b(a);}).fail(function(a){c(a);}).done();},dealPluginArgs:function dealPluginArgs(a){return a}});

  var L$k=U.global.xsloader;L$k.define("window",{isSingle:true,pluginMain:function pluginMain(a,b,c){var d=a.indexOf("=>>");if(-1==d){c("expected:=>>");return}var e=a.substring(0,d),f=a.substring(d+3);this.invoker().withAbsUrl().require([f],function(a){window[e]=a;b(a);}).setTag("window!".concat(a));}});
  ...
  var L$m=U.global.xsloader;L$m.define("json",["xshttp"],{isSingle:true,pluginMain:function pluginMain(a,b,c,d,e){var f=this.invoker().getUrl(a,true);e().url(f).handleAs("json").ok(function(a){b(a);}).fail(function(a){c(a);}).done();},dealPluginArgs:function dealPluginArgs(a){return a}});
  ...
  var L$q=U.global.xsloader;L$q.define("image",{pluginMain:function pluginMain(a,b,c,d){var e=this.invoker().getUrl(a,false),f=new Image,g=function(a){var c=f;f=null;c.onload=null;c.οnerrοr=null;b(a?c:null);};f.onload=function(){g(true);};f.οnerrοr=function(){g(false);};f.src=e;L$q.asyncCall(function(){if(f){setTimeout(function(){if(f){g(false);}},d.plugins.image.timeout);}});},dealPluginArgs:function dealPluginArgs(a){return a}});

  var L$r=U.global.xsloader;L$r.define("default",{isSingle:true,pluginMain:function pluginMain(a,b,c){this.invoker().withAbsUrl().require([a],function(a){if(L$r.isObject(a)){a=a["default"];if(a===void 0){a=null;}}else {a=null;}b(a);}).error(function(a){c(a);}).setTag("default!".concat(a));}});
