/*!
 * xsloader.min.js v1.1.48
 * home:https://github.com/gzxishan/xsloader#readme
 * (c) 2018-2021 gzxishan
 * Released under the Apache-2.0 License.
 * build time:Sat May 22 2021 21:49:54 GMT+0800 (GMT+08:00)
 */
(function () {
  'use strict';
  ...
  var G$5=U.global,L$6=G$5.xsloader,env={version:"1.1.48"},toGlobal=_objectSpread2({},deprecated,{},base$1);for(var k in toGlobal){L$6[k]=toGlobal[k];G$5[k]=toGlobal[k];}var justLoader=_objectSpread2({},is,{},funs,{},browser,{ignoreAspect_:{},each:U.each,Base64:U.base64,env:env});for(var _k in justLoader){L$6[_k]=justLoader[_k];}
  ...
  var L$g=U.global.xsloader,CONNS_MAP={},DEBUG_OPTION={logMessage:false},Debug=function(){function a(){_classCallCheck(this,a);}_createClass(a,[{key:"logMessage",set:function set(a){DEBUG_OPTION.logMessage=!!a;},get:function get(){return DEBUG_OPTION.logMessage}}]);return a}();function currentTimemillis(){return new Date().getTime()}function runAfter(a,b){return setTimeout(b,a)}function clearRunAfter(a){clearTimeout(a);}var timer=null;function destroyTimer(){if(timer){clearInterval(timer);timer=null;}}function startTimer(){destroyTimer();timer=setInterval(function(){for(var a in CONNS_MAP){var b=CONNS_MAP[a];for(var c in b.clients){b.clients[c].checkHeart();}for(var d in b.selfclients){b.selfclients[d].checkHeart();}}},1e3*parseInt(5+10*Math.random()));}function doSendMessage(a,b,c){c=_objectSpread2({isserver:!!a},c,{__ifmsg:true});try{b.postMessage(c,"*");}catch(a){console.error(a);console.error(c);}}function checkSource(a,b){if(a&&a.source!=b){console.error("source error:",a.source,b);throw new Error("source error:not match")}}var MESSAGE_LISTENER=function(a){var b=a.data,c=a.source,d=a.origin;if(L$g.isObject(b)&&true===b.__ifmsg){var e=b.cmd,f=b.fromid,g=b.toid,h=b.mdata,i=b.type,j=b.err,k=b.isserver;if(DEBUG_OPTION.logMessage){console.log(location.href," receive:");console.log(b);}var l=CONNS_MAP[e];if(!l){if("ignore"!=i){doSendMessage(!k,c,{cmd:e,type:"ignore",toid:f,data:b});}}else{if("connecting"==i){if(!l.server){doSendMessage(!k,c,{cmd:e,type:"connecting-fail",toid:f,err:"not a server,cmd=".concat(e)});}else{if(l.clients[f]){if(currentTimemillis()-l.clients[f]._createTime>10000){doSendMessage(!k,c,{cmd:e,type:"connecting-fail:duplicate",toid:f,err:"duplicate fromid[".concat(f,"],cmd=").concat(e)});}}else{var m=new Client(e,c,d,f);m._conntimeout=l.server._connTimeout;m._sleeptimeout=l.server._sleepTimeout;doSendMessage(!k,c,{cmd:e,type:"connect",fromid:l.server.id,toid:f});l.server.onConnect(m,h);}}}else if("connecting-fail:duplicate"==i){console.warn(j);}else if("connecting-fail"==i){var n=l.selfclients[g];checkSource(n,c);if(n){n.gotConnectingFail(j);}else{console.warn(j);}}else if("connect"==i){var o=l.selfclients[g];checkSource(o,c);if(!o){doSendMessage(!k,c,{cmd:e,type:"connect-fail",toid:f,fromid:g,err:"client not found:clientid=".concat(g)});}}else if("connect-fail"==i){console.warn(j);}else if("connected"==i){var p;if(k){p=l.selfclients[g];}else{p=l.clients[f];}checkSource(p,c);if(p){if(k){p.gotConnect(f,c,d,h);}}}else if("message"==i){var q;if(k){q=l.selfclients[g];}else{q=l.clients[f];}checkSource(q,c);if(q){if(k){q.gotMessage(h);}else{q.gotMessage(h);}}}else if("close"==i){var r;if(k){r=l.selfclients[g];}else{r=l.clients[f];}checkSource(r,c);if(r){r.close();}}else if("closed"==i){var s;if(k){s=l.selfclients[g];}else{s=l.clients[f];}c&&checkSource(s,c);if(s){s.close(false,void 0,h);}}else if("heart"==i){var t;if(k){t=l.selfclients[g];}else{t=l.clients[f];}checkSource(t,c);if(t){t.gotHeart();doSendMessage(!k,c,{cmd:e,type:"rheart",toid:f,fromid:g});}}else if("rheart"==i){var u;if(k){u=l.selfclients[g];}else{u=l.clients[f];}checkSource(u,c);if(u){u.gotHeart();}}}}},Callback=function(){function a(b,c){_classCallCheck(this,a);this.thiz=void 0;this.callback=void 0;this.thiz=b;this.callback=c;}_createClass(a,[{key:"invoke",value:function invoke(a){return this.callback.apply(this.thiz,a)}}]);return a}();Callback.call=function(a,b){if(b){for(var c=[],d=2;d<arguments.length;d++){c.push(arguments[d]);}if(b instanceof Callback){return b.invoke(c)}else{return b.apply(a,c)}}};var autoClosablesOnWindowClose={};window.addEventListener("beforeunload",function(){var a=autoClosablesOnWindowClose;autoClosablesOnWindowClose={};var b={type:"beforeunload"};for(var e in a){try{var c=a[e],d=c.getUnloadData(_objectSpread2({},b));c.close(true,_objectSpread2({},b,{data:d}));}catch(a){console.warn(a);}}});window.addEventListener("unload",function(){var a=autoClosablesOnWindowClose;autoClosablesOnWindowClose={};var b={type:"unload"};for(var e in a){try{var c=a[e],d=c.getUnloadData(_objectSpread2({},b));c.close(true,_objectSpread2({},b,{data:d}));}catch(a){console.warn(a);}}});function autoCloseOnWindowClose(a){var b=L$g.randId();autoClosablesOnWindowClose[b]=a;return function(){delete autoClosablesOnWindowClose[b];}}var _onclose=_classPrivateFieldLooseKey("onclose"),Base=function(){function a(){var b=0<arguments.length&&arguments[0]!==void 0?arguments[0]:"default";_classCallCheck(this,a);this._cmd=void 0;this._id=void 0;Object.defineProperty(this,_onclose,{writable:true,value:void 0});this._cmd=b;this._id=L$g.randId();_classPrivateFieldLooseBase(this,_onclose)[_onclose]=autoCloseOnWindowClose(this);}_createClass(a,[{key:"closeBase",value:function closeBase(){var a=CONNS_MAP[this.cmd];if(a){if(!a.server&&U.isEmptyObject(a.clients)&&U.isEmptyObject(a.selfclients)){delete CONNS_MAP[this.cmd];if(U.isEmptyObject(CONNS_MAP)){window.removeEventListener("message",MESSAGE_LISTENER);destroyTimer();}}}if(_classPrivateFieldLooseBase(this,_onclose)[_onclose]){_classPrivateFieldLooseBase(this,_onclose)[_onclose]();_classPrivateFieldLooseBase(this,_onclose)[_onclose]=null;}}},{key:"cmd",get:function get(){return this._cmd}},{key:"id",get:function get(){return this._id}}]);return a}(),_source=_classPrivateFieldLooseKey("source"),_isself=_classPrivateFieldLooseKey("isself"),Client=function(a){_inherits(b,a);function b(a,c,d,e){var f,g=4<arguments.length&&arguments[4]!==void 0?arguments[4]:false;_classCallCheck(this,b);f=_possibleConstructorReturn(this,_getPrototypeOf(b).call(this,a));Object.defineProperty(_assertThisInitialized(f),_source,{writable:true,value:void 0});f._origin=void 0;f._fromid=void 0;f._connect=void 0;f._connected=false;f._destroyed=false;f._onConnect=void 0;f._onConnectFail=void 0;Object.defineProperty(_assertThisInitialized(f),_isself,{writable:true,value:void 0});f._conntimeout=void 0;f._sleeptimeout=void 0;f._rtimer=void 0;f._starttime=void 0;f._failed=void 0;f._heartTimeout=30000;f._heartTime=10000;f._lastSendHeartTime=0;f._lastReceiveHeartTime=0;f._onHeartTimeout=void 0;f._onUnload=void 0;f._onClosed=void 0;f._onMessage=void 0;f._onConnected=void 0;f._createTime=currentTimemillis();_classPrivateFieldLooseBase(_assertThisInitialized(f),_source)[_source]=c;f._origin=d;f._fromid=e;_classPrivateFieldLooseBase(_assertThisInitialized(f),_isself)[_isself]=g;return f}_createClass(b,[{key:"isTimeout",value:function isTimeout(){var a=currentTimemillis()-this._starttime;return a>this._conntimeout}},{key:"connect",value:function connect(a){var b=this;if(!this.isself){throw new Error("not allowed for server client!")}else if(this.connected);else if(this.destroyed){throw new Error("destroyed!")}else if(!this.source){throw new Error("no source!")}else{if(!this._starttime||this._failed){this._failed=false;this._starttime=currentTimemillis();this._connect=false;}else if(this._connect){return}if(U.isEmptyObject(CONNS_MAP)){window.addEventListener("message",MESSAGE_LISTENER);startTimer();}var c={cmd:this.cmd,type:"connecting",fromid:this.id,mdata:a};if(!CONNS_MAP[this.cmd]){CONNS_MAP[this.cmd]={server:null,clients:{},selfclients:{}};}CONNS_MAP[this.cmd].selfclients[this.id]=this;doSendMessage(false,this.source,c);this._rtimer=runAfter(this._sleeptimeout,function(){if(b.connected||b._failed||b._connect||b._destroyed);else if(b.isTimeout()){if(!b.connected){b._failed=true;Callback.call(b,b._onConnectFail,{cmd:b.cmd,type:"timeout:connecting"});}}else{b.connect(a);}});}}},{key:"checkHeart",value:function checkHeart(){if(this.connected&&!this._destroyed){var a=currentTimemillis();if(a-this._lastReceiveHeartTime>this._heartTimeout){try{Callback.call(this,this._onHeartTimeout);}finally{this.close();}}else if(a-this._lastSendHeartTime>this._heartTime){this._lastSendHeartTime=a;doSendMessage(!this.isself,this.source,{cmd:this.cmd,type:"heart",fromid:this.id,toid:this.fromid});}}}},{key:"gotHeart",value:function gotHeart(){this._lastReceiveHeartTime=currentTimemillis();}},{key:"checkClientConnected",value:function checkClientConnected(a){var b=this;if(!this._connected&&!this._destroyed&&!this._failed){if(!this._starttime){this._starttime=currentTimemillis();this._connect=true;}if(this.isTimeout()){try{Callback.call(this,a._onConnectTimeout,this);}finally{this.close();}}else{this._rtimer=runAfter(this._sleeptimeout,function(){b.checkClientConnected(a);});}}}},{key:"gotConnectingFail",value:function gotConnectingFail(a){this._failed=true;Callback.call(this,this._onConnectFail,{cmd:this.cmd,type:"fail:connecting",err:a});}},{key:"gotConnect",value:function gotConnect(a,b,c,d){var e=this;this._fromid=a;if(!this._connect&&!this._connected&&!this._destroyed&&!this._failed){this._connect=true;var f=this._onConnect||function(a,b,c,d){var e=location.protocol+"//"+location.host;d(e==b,null);},g=function(a,b){if(a){e.gotConnected();doSendMessage(false,e.source,{cmd:e.cmd,type:"connected",fromid:e.id,toid:e.fromid});var c=e._onConnected;Callback.call(e,c);}else{doSendMessage(false,e.source,{cmd:e.cmd,type:"connected-fail",err:b,fromid:e.id,toid:e.fromid});}};Callback.call(this,f,b,c,d,g);}}},{key:"gotConnected",value:function gotConnected(){clearRunAfter(this._rtimer);this._rtimer=null;var a=currentTimemillis();this._lastSendHeartTime=a;this._lastReceiveHeartTime=a;this._connected=true;}},{key:"gotMessage",value:function gotMessage(a){Callback.call(this,this._onMessage,a);}},{key:"getUnloadData",value:function getUnloadData(a){if(this.connected){return Callback.call(this,this._onUnload,a)}}},{key:"close",value:function close(){var a=0<arguments.length&&arguments[0]!==void 0?arguments[0]:true,b=1<arguments.length?arguments[1]:void 0,c=2<arguments.length?arguments[2]:void 0;if(this.connected){try{var d=CONNS_MAP[this.cmd];if(d){if(this.isself){if(d.selfclients){delete d.selfclients[this.id];}}else{if(d.clients){delete d.clients[this.fromid];}}}if(this._rtimer){clearRunAfter(this._rtimer);this._rtimer=null;}this._connected=false;this._destroyed=true;this.closeBase();if(a&&this.source){doSendMessage(!this.isself,this.source,{cmd:this.cmd,type:"closed",mdata:b,fromid:this.id,toid:this.fromid});}}finally{Callback.call(this,this._onClosed,c);}}}},{key:"sendMessage",value:function sendMessage(a){if(this.destroyed){throw new Error("destroyed!")}else if(this.connected){doSendMessage(!this.isself,this.source,{cmd:this.cmd,type:"message",mdata:a,fromid:this.id,toid:this.fromid});}else{throw new Error("not connected!")}}},{key:"source",get:function get(){return _classPrivateFieldLooseBase(this,_source)[_source]},set:function set(a){if(_classPrivateFieldLooseBase(this,_source)[_source]){throw new Error("already exists source:id=".concat(this.id))}_classPrivateFieldLooseBase(this,_source)[_source]=a;}},{key:"isself",get:function get(){return _classPrivateFieldLooseBase(this,_isself)[_isself]}},{key:"origin",get:function get(){return this._origin}},{key:"fromid",get:function get(){return this._fromid}},{key:"connected",get:function get(){return this._connected}},{key:"destroyed",get:function get(){return this._destroyed}},{key:"onHeartTimeout",set:function set(a){this._onHeartTimeout=a?new Callback(this,a):null;},get:function get(){return this._onHeartTimeout&&this._onHeartTimeout.callback}},{key:"onUnload",set:function set(a){this._onUnload=a?new Callback(this,a):null;},get:function get(){return this._onUnload&&this._onUnload.callback}},{key:"onClosed",set:function set(a){this._onClosed=a?new Callback(this,a):null;},get:function get(){return this._onClosed&&this._onClosed.callback}},{key:"onMessage",set:function set(a){this._onMessage=a?new Callback(this,a):null;},get:function get(){return this._onMessage&&this._onMessage.callback}}]);return b}(Base),_singleMode=_classPrivateFieldLooseKey("singleMode"),_singleClient=_classPrivateFieldLooseKey("singleClient"),Server=function(a){_inherits(b,a);function b(a,c){var d;_classCallCheck(this,b);d=_possibleConstructorReturn(this,_getPrototypeOf(b).call(this,a));d._start=void 0;d._destroyed=false;d._onConnect=void 0;d._onConnectTimeout=void 0;d._onConnected=void 0;d._conntimeout=void 0;d._sleeptimeout=void 0;Object.defineProperty(_assertThisInitialized(d),_singleMode,{writable:true,value:void 0});Object.defineProperty(_assertThisInitialized(d),_singleClient,{writable:true,value:void 0});_classPrivateFieldLooseBase(_assertThisInitialized(d),_singleMode)[_singleMode]=c;d._id=L$g.randId();d.onConnectTimeout=function(a){console.warn("client connect timeout:",a);};return d}_createClass(b,[{key:"onConnect",value:function onConnect(a,b){var c=this,d=CONNS_MAP[this.cmd];d.clients[a.fromid]=a;var e=this._onConnect||function(a,b,c){var d=location.protocol+"//"+location.host;c(d==a.origin,null);};Callback.call(this,e,a,b,function callback(b,d){if(b){a.gotConnected();doSendMessage(true,a.source,{cmd:c.cmd,type:"connected",mdata:d,fromid:c.id,toid:a.fromid});if(_classPrivateFieldLooseBase(c,_singleMode)[_singleMode]&&_classPrivateFieldLooseBase(c,_singleClient)[_singleClient]){_classPrivateFieldLooseBase(c,_singleClient)[_singleClient].close();_classPrivateFieldLooseBase(c,_singleClient)[_singleClient]=null;}var e=c._onConnected||function(){if(_classPrivateFieldLooseBase(c,_singleMode)[_singleMode]){_classPrivateFieldLooseBase(c,_singleClient)[_singleClient]=null;}a.close(false);doSendMessage(true,a.source,{cmd:c.cmd,type:"close",mdata:"not exists connected handle",fromid:c.id,toid:a.fromid});};if(_classPrivateFieldLooseBase(c,_singleMode)[_singleMode]){_classPrivateFieldLooseBase(c,_singleClient)[_singleClient]=a;}Callback.call(c,e,a);a.checkClientConnected(c);}else{a.close(false);doSendMessage(true,a.source,{cmd:c.cmd,type:"connected-fail",err:d,fromid:c.id,toid:a.fromid});}});}},{key:"close",value:function close(a,b){if(this._destroyed){throw new Error("already destroyed!")}else{var c=CONNS_MAP[this.cmd];if(!c.server||c.server!=this){throw new Error("server cmd not match:cmd=".concat(this.cmd))}else{this._destroyed=true;this._start=false;for(var d in c.clients){try{var e=c.clients[d];if(e.connected){e.close(a,b);}}catch(a){console.error(a);}}c.clients={};c.server=null;_classPrivateFieldLooseBase(this,_singleClient)[_singleClient]=null;this.closeBase();}}}},{key:"listen",value:function listen(){if(CONNS_MAP[this.cmd]){throw new Error("already listened:cmd=".concat(this.cmd))}else{if(U.isEmptyObject(CONNS_MAP)){window.addEventListener("message",MESSAGE_LISTENER);startTimer();}if(!CONNS_MAP[this.cmd]){CONNS_MAP[this.cmd]={server:null,clients:{},selfclients:{}};}CONNS_MAP[this.cmd].server=this;this._start=true;}}},{key:"isSingle",get:function get(){return _classPrivateFieldLooseBase(this,_singleMode)[_singleMode]}},{key:"client",get:function get(){if(!_classPrivateFieldLooseBase(this,_singleMode)[_singleMode]){throw new Error("not single mode")}else{return _classPrivateFieldLooseBase(this,_singleClient)[_singleClient]}}}]);return b}(Base),_server=_classPrivateFieldLooseKey("server"),IfmsgServer=function(){function a(b,c){_classCallCheck(this,a);Object.defineProperty(this,_server,{writable:true,value:void 0});var d=L$g.config().plugins.ifmsg;if(true===c||false===c){c={singleMode:c};}c=L$g.extend({connTimeout:d.connTimeout,sleepTimeout:d.sleepTimeout,singleMode:false},c);_classPrivateFieldLooseBase(this,_server)[_server]=new Server(b,c.singleMode);_classPrivateFieldLooseBase(this,_server)[_server]._conntimeout=c.connTimeout;_classPrivateFieldLooseBase(this,_server)[_server]._sleeptimeout=c.sleepTimeout;}_createClass(a,[{key:"listen",value:function listen(){_classPrivateFieldLooseBase(this,_server)[_server].listen();}},{key:"close",value:function close(a){_classPrivateFieldLooseBase(this,_server)[_server].close(true,a);}},{key:"onConnect",set:function set(a){_classPrivateFieldLooseBase(this,_server)[_server]._onConnect=a?new Callback(this,a):null;},get:function get(){return _classPrivateFieldLooseBase(this,_server)[_server]._onConnect&&_classPrivateFieldLooseBase(this,_server)[_server]._onConnect.callback}},{key:"onConnectTimeout",set:function set(a){_classPrivateFieldLooseBase(this,_server)[_server]._onConnectTimeout=a?new Callback(this,a):null;},get:function get(){return _classPrivateFieldLooseBase(this,_server)[_server]._onConnectTimeout&&_classPrivateFieldLooseBase(this,_server)[_server]._onConnectTimeout.callback}},{key:"onConnected",set:function set(a){_classPrivateFieldLooseBase(this,_server)[_server]._onConnected=a?new Callback(this,a):null;},get:function get(){return _classPrivateFieldLooseBase(this,_server)[_server]._onConnected&&_classPrivateFieldLooseBase(this,_server)[_server]._onConnected.callback}},{key:"isStart",get:function get(){return _classPrivateFieldLooseBase(this,_server)[_server]._start}},{key:"isDestroyed",get:function get(){return _classPrivateFieldLooseBase(this,_server)[_server]._destroyed}},{key:"cmd",get:function get(){return _classPrivateFieldLooseBase(this,_server)[_server].cmd}},{key:"isSingle",get:function get(){return _classPrivateFieldLooseBase(this,_server)[_server].isSingle}},{key:"client",get:function get(){return _classPrivateFieldLooseBase(this,_server)[_server].client}}]);return a}(),_client9=_classPrivateFieldLooseKey("client"),IfmsgClient=function(){function a(b,c){_classCallCheck(this,a);Object.defineProperty(this,_client9,{writable:true,value:void 0});var d=L$g.config().plugins.ifmsg;c=L$g.extend({connTimeout:d.connTimeout,sleepTimeout:d.sleepTimeout},c);_classPrivateFieldLooseBase(this,_client9)[_client9]=new Client(b,null,null,null,true);_classPrivateFieldLooseBase(this,_client9)[_client9]._conntimeout=c.connTimeout;_classPrivateFieldLooseBase(this,_client9)[_client9]._sleeptimeout=c.sleepTimeout;this.onConnectFail=function(a){console.warn(a);};}_createClass(a,[{key:"connIframe",value:function connIframe(a,b){var c=this;if("string"==typeof a){a=document.getElementById(a);var d=function(){a.removeEventListener("load",d);var e=a.contentWindow;_classPrivateFieldLooseBase(c,_client9)[_client9].source=e;_classPrivateFieldLooseBase(c,_client9)[_client9].connect(b);};a.addEventListener("load",d);}else{var e=a.contentWindow;_classPrivateFieldLooseBase(this,_client9)[_client9].source=e;_classPrivateFieldLooseBase(this,_client9)[_client9].connect(b);}}},{key:"connParent",value:function connParent(a){_classPrivateFieldLooseBase(this,_client9)[_client9].source=window.parent;_classPrivateFieldLooseBase(this,_client9)[_client9].connect(a);}},{key:"connTop",value:function connTop(a){_classPrivateFieldLooseBase(this,_client9)[_client9].source=window.top;_classPrivateFieldLooseBase(this,_client9)[_client9].connect(a);}},{key:"connOpener",value:function connOpener(a){_classPrivateFieldLooseBase(this,_client9)[_client9].source=window.opener;_classPrivateFieldLooseBase(this,_client9)[_client9].connect(a);}},{key:"sendMessage",value:function sendMessage(a){_classPrivateFieldLooseBase(this,_client9)[_client9].sendMessage(a);}},{key:"close",value:function close(a){_classPrivateFieldLooseBase(this,_client9)[_client9].close(true,a);}},{key:"onConnect",set:function set(a){_classPrivateFieldLooseBase(this,_client9)[_client9]._onConnect=a?new Callback(this,a):null;},get:function get(){return _classPrivateFieldLooseBase(this,_client9)[_client9]._onConnect&&_classPrivateFieldLooseBase(this,_client9)[_client9]._onConnect.callback}},{key:"onConnected",set:function set(a){_classPrivateFieldLooseBase(this,_client9)[_client9]._onConnected=a?new Callback(this,a):null;},get:function get(){return _classPrivateFieldLooseBase(this,_client9)[_client9]._onConnected&&_classPrivateFieldLooseBase(this,_client9)[_client9]._onConnected.callback}},{key:"onHeartTimeout",set:function set(a){_classPrivateFieldLooseBase(this,_client9)[_client9].onHeartTimeout=a;},get:function get(){return _classPrivateFieldLooseBase(this,_client9)[_client9].onHeartTimeout}},{key:"onUnload",set:function set(a){_classPrivateFieldLooseBase(this,_client9)[_client9].onUnload=a;},get:function get(){return _classPrivateFieldLooseBase(this,_client9)[_client9].onUnload}},{key:"onClosed",set:function set(a){_classPrivateFieldLooseBase(this,_client9)[_client9].onClosed=a;},get:function get(){return _classPrivateFieldLooseBase(this,_client9)[_client9].onClosed}},{key:"onMessage",set:function set(a){_classPrivateFieldLooseBase(this,_client9)[_client9].onMessage=a;},get:function get(){return _classPrivateFieldLooseBase(this,_client9)[_client9].onMessage}},{key:"onConnectFail",set:function set(a){_classPrivateFieldLooseBase(this,_client9)[_client9]._onConnectFail=a?new Callback(this,a):null;},get:function get(){return _classPrivateFieldLooseBase(this,_client9)[_client9]._onConnectFail&&_classPrivateFieldLooseBase(this,_client9)[_client9]._onConnectFail.callback}},{key:"connected",get:function get(){return _classPrivateFieldLooseBase(this,_client9)[_client9].connected}},{key:"destroyed",get:function get(){return _classPrivateFieldLooseBase(this,_client9)[_client9].destroyed}}]);return a}();L$g.define("ifmsg",{Server:IfmsgServer,Client:IfmsgClient,debug:new Debug});
