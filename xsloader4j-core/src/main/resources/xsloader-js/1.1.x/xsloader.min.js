/*!
 * xsloader.min.js v1.1.13
 * home:https://github.com/gzxishan/xsloader#readme
 * (c) 2018-2020 gzxishan
 * Released under the Apache-2.0 License.
 * build time:Thu Apr 09 2020 15:53:02 GMT+0800 (GMT+08:00)
 */
(function () {
  'use strict';
  ...
  var G$4=U.global,L$5=G$4.xsloader,isDOM="object"===("undefined"==typeof HTMLElement?"undefined":_typeof(HTMLElement))?function(a){return a&&a instanceof HTMLElement}:function(a){return a&&"object"===_typeof(a)&&1===a.nodeType&&"string"==typeof a.nodeName},onReadyFun=function(){var b=false,c=[];function a(a){if(b){a();return}var d=false;function c(){if(d)return;d=true;b=true;a();}if(document.addEventListener){var e=function fun(){document.removeEventListener("DOMContentLoaded",e);c();};document.addEventListener("DOMContentLoaded",e);}else if(document.attachEvent){var f=function fun(){if("complete"===document.readyState){document.detachEvent("onreadystatechange",f);c();}};document.attachEvent("onreadystatechange",f);var g=function fun2(){if(d)return;try{document.documentElement.doScroll("left");}catch(a){setTimeout(g,0);return}c();};if(document.documentElement.doScroll&&"undefined"==typeof G$4.frameElement)g();}else {L$5.asyncCall(null,true).next(function(){c();});}this.readyCall=c;}var d=function(d){if("complete"===document.readyState){b=true;}if(b){d();}else {var e=new a(d);c.push(e);}};d(function(){b=true;});if("complete"===document.readyState){b=true;}else {var e;if(document.addEventListener){e=function(a,b){document.addEventListener(a,b,false);};}else if(document.attachEvent){e=function(a,b){document.attachEvent("on"+a,b);};}else {e=function(a,b){L$5.asyncCall(null,true).next(function(){b();});};}e("load",function(){b=true;while(c.length){c.shift().readyCall();}});}return d}();var browser = {isDOM:isDOM,onReady:onReadyFun};

  var G$5=U.global,L$6=G$5.xsloader,env={version:"1.1.13"},toGlobal=_objectSpread2({},deprecated,{},base$1);for(var k in toGlobal){L$6[k]=toGlobal[k];G$5[k]=toGlobal[k];}var justLoader=_objectSpread2({},is,{},funs,{},browser,{ignoreAspect_:{},each:U.each,Base64:U.base64,env:env});for(var _k in justLoader){L$6[_k]=justLoader[_k];}
